...
- JurisProp project pitch deck (`JurisProp_Proposal.pptx`) — primary source for these requirements
- Approved local real-estate law databases used as the generation engine's reference

---

*This README is derived from the JurisProp SRS v1.0 (dated 21/07/2026) and summarizes the document for engineering onboarding. Refer to the full SRS for complete, authoritative requirement details.*
